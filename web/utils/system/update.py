...
def getServerInfo():
    ...
    import ssl
    upAddr = 'https://api.github.com/repos/ramondelee/mdserver-web/releases/latest'
    try:
...
def updateServer(stype, version=''):
    ...
    try:
        ...
        if stype == 'update':
            ...
            newUrl = "https://github.com/ramondelee/mdserver-web/archive/refs/tags/" + version + ".zip"
